...
public class RaceCameraManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        wholeHeight = new Vector3(0, (distance + 30) / 2);
    ...
    void Update()
    {
        switch (cameraMode)
        {
            ...
            case CameraMode.Goal:
                ...
                Camera.main.transform.position = GoalObj.transform.position + (GoalObj.transform.position - StartObj.transform.position) * 0.3f + wholeHeight / 2.5f;
                break;
